...
<a href="<?php index(); ?>">
    ...
    <div class="alert alert-success">
        ...
        <strong>Tambah Data Wilayah </strong>
        <hr class="message-inner-separator">
            <p>Silahkan input Data Wilayah  dibawah ini.</p>
        </div>
    </div>
                ...
                <table <?php tabel_in(100, '%', 0, 'center'); ?>>		
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="2%">:</td>
                            <td>
                              <?php echo id_otomatis("data_wilayah", "id_wilayah", "10"); ?>  		
                            </td>
                        </tr>
                        h-->
                        <input type="hidden" class="form-control" readonly value="<?php echo id_otomatis("data_wilayah", "id_wilayah", "10"); ?>" name="id_wilayah" placeholder="Id Wilayah " id="id_wilayah" required="required">
