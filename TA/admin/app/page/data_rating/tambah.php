...
<a href="<?php index(); ?>">
    ...
    <div class="alert alert-success">
        ...
        <strong>Tambah Data Rating </strong>
        <hr class="message-inner-separator">
            <p>Silahkan input Data Rating  dibawah ini.</p>
        </div>
    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td width="25%" class="leftrowcms">					
                                <label >Id Rating  <span class="highlight">*</span></label>
                            </td>
                            <td width="2%">:</td>
                            <td>
                              <?php echo id_otomatis("data_rating", "id_rating", "10"); ?>  		
                            </td>
                        </tr>
                        h-->
                        <input type="hidden" class="form-control" readonly value="<?php echo id_otomatis("data_rating", "id_rating", "10"); ?>" name="id_rating" placeholder="Id Rating " id="id_rating" required="required">
